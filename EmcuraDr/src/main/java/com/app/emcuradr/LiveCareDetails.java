...
public class LiveCareDetails extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvICcodes = (TextView) findViewById(R.id.tvIcdCodes);
    ...
    public void getIcdCodes() {
        RequestParams params = new RequestParams();
        params.put("id",DATA.selectedUserAppntID);
        ApiManager apiManager = new ApiManager(ApiManager.GET_ICD_CODES2 , "post", params, this, activity);
    ...
    public void fetchDataCallback(String httpStatus, String apiName, String content) {
        ...
        if (apiName.contains(ApiManager.PATIENT_DETAIL_URGENTCARE)) {
            ...
            try {
                ...
                DATA.selectedUserCallDOB = patient_data.getString("birthdate");

                tvSelPtDOB.setText(DATA.selectedUserCallDOB);
        ...
        else if(apiName.equalsIgnoreCase(ApiManager.GET_ICD_CODES2)){
            try {
                JSONObject jsonObject = new JSONObject(content);
                JSONArray jsonArray = jsonObject.getJSONArray("data");

                //IcdCodeBean bean = gson.fromJson(jsonArray.toString(), IcdCodeBean.class);

                ArrayList<IcdCodeBean> icdCodeBeans = gson.fromJson(jsonArray.toString(), new TypeToken<ArrayList<IcdCodeBean>>() {}.getType());
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    String icdCode = "• "+object.get("code")+" - "+object.get("desc")+"\n";
                    icdCodeString +=icdCode;
                    }
                tvICcodes.setText(icdCodeString);


                sharedPrefsHelper.save("patient_icd_codes",icdCodeString);
