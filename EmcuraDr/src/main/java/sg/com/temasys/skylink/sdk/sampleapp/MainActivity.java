...
import com.app.emcuradr.fcm.MyFirebaseMessagingService;
...
import com.app.emcuradr.util.RingtonePlayer;
...
public class MainActivity extends AppCompatActivity
        implements GloabalSocket.SocketEmitterCallBack {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (DATA.isCallRejected) {
                    ...
                    /*if (DATA.isSessionRunning) {
                        DATA.print("--DATA.isSessionRunning = true");
                    } else {
                        if (((ooVooSdkSampleShowApp) getApplication()).isInConference()) {
        ...
        client.get(reqURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    DATA.print("--Response in clinic drs: " + content);
