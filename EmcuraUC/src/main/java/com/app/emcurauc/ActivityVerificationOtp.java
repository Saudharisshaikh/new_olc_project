...
public class ActivityVerificationOtp extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPhone = prefs.getString("userEnterPhone", "");
...
//            alertDialog.show();
        ...
        else if (Login.loginFrom.equals("2")) {
            reSendOtp();
            tvOtpTimer.setVisibility(View.GONE);
            layResendCode.setVisibility(View.GONE);
//            if (countDownTimer != null) {
...
//            countDownTimer.start();
    ...
    private void optVerify(String otpCodeSms) {
        ...
        /*     params.put("email_code" , otpCodeEmail);*/
        ...
        if (apiName.equals(ApiManager.OTP_VERIFY)) {
            try {
                ...
                if (status.equals("success")) {
                    ...
                    ed1.putBoolean("UserSignupSuccess", true);
                    ed1.commit();
                    ...
                    NewSignup.is_signup_successfull = true;
