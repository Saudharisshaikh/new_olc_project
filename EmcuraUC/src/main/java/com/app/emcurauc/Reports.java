...
import com.app.emcurauc.adapter.ReportsGridAdapter;
...
//								|| DATA.selectedReprtExtension.equals(".xlsx")
    ...
    protected void onActivityResult(int requestCode, final int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            if (!filePaths.isEmpty()) {
                ...
                System.out.println("--path ahmer new " + DATA.selectedReprtPath);
    ...
    public void PickiTonCompleteListener(String path, boolean wasDriveFile, boolean wasUnknownProvider, boolean wasSuccessful, String Reason) {
        ...
        if (wasSuccessful) {
            ...
            if (path.contains("/proc/")) {
                DATA.print("Sub-directory inside Downloads was selected." + "\n" + " We will be making use of the /proc/ protocol." + "\n" + " You can use this path as you would normally." + "\n\n" + "PickiT path:" + "\n" + path);
            } else {
                DATA.print(path);
                docPaths = new ArrayList<>();
                docPaths.add(""+path);

                ArrayList<String> filePathss = new ArrayList<>();

                if (docPaths != null) filePathss.addAll(docPaths);

                DATA.print("--total files: "+filePathss.size());

                if(!filePathss.isEmpty()){
                    DATA.selectedReprtPath = filePathss.get(0);
    ...
    //Ahmer code for doc picker android 13
    /**
