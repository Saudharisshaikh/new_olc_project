...
import com.app.emcurauc.adapter.MessageAdapter;
import com.app.emcurauc.api.ApiManager;
import com.app.emcurauc.api.Dialog_CustomProgress;
import com.app.emcurauc.model.MessageBean;
...
public class ViewConversationActivity extends BaseActivity{
	...
	RelativeLayout bottom_write_bar,layout_message_error;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bottom_write_bar = findViewById(R.id.bottom_write_bar);
		layout_message_error = findViewById(R.id.layout_message_error);
	...
	public void fetchDataCallback(String httpstatus, String apiName, String content) {
		if(apiName.contains(ApiManager.VIEW_CONVERSATIONS)){
			try {
				...
				try {
					JSONObject liveCheckups = jsonObject.getJSONObject("livecheckups");
					messageStatus = liveCheckups.getString("status");
					if(messageStatus.equals("0")){
						bottom_write_bar.setVisibility(View.VISIBLE);
						layout_message_error.setVisibility(View.GONE);
					}
					else {
						bottom_write_bar.setVisibility(View.INVISIBLE);
						layout_message_error.setVisibility(View.VISIBLE);
					}
