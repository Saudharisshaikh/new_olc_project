...
import com.app.emcurauc.MyPrescriptionActivity;
...
public class PatientPrescriptionAdapter extends RecyclerView.Adapter<PatientPrescriptionAdapter.ViewHolder> {
    ...
    public PatientPrescriptionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.my_prescription_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            date1 = itemView.findViewById(R.id.presp_date);
            date2 = itemView.findViewById(R.id.presp_date2);
            treatment = itemView.findViewById(R.id.presp_treatment);
            diagnosis = itemView.findViewById(R.id.presp_diagnosis);
            doctor = itemView.findViewById(R.id.presp_doctor);
            btnViewDetails = itemView.findViewById(R.id.presp_btn_viewdetails);
        }
    }
}
