...
import static com.app.emcurauc.util.DATA.SIGNUP_URL;
import static com.app.emcurauc.util.DATA.baseUrl;
...
public class ApiManager {
    ...
    public static final String CHECK_PATIENT_REGISTRATION = "patient_registration/checkpatient";

    public static final String PATIENT_SIGNUP_NEW = "patient_registration/save";
    ...
    public static final String REMOVE_FROM_UC = "patient/remove_from_care";
    ...
    public static final String GET_PATIENT_INSURANCE = "surescript/getinsurance_patient";
    ...
    public static final String CHECK_SOCIAL = "patient_registration/checksocial";
            ...
            client.post(customURL, params, new AsyncHttpResponseHandler() {
                ...
                public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                    ...
                    try {
                        ...
                        if (api.contains(ApiManager.GET_WAITING_PATIENTS)) {
                            DATA.shouldLiveCareWatingRefresh = 1;
                        }//for livecarewaitingarea
                        customSnakeBar.showToast(DATA.CMN_ERR_MSG);
