...
import com.app.emcurauc.SelectReports;
...
import com.app.emcurauc.b_health.assessment.ActivityDAST_Form;
import com.app.emcurauc.b_health.assessment.ActivityPHQ_Form;
import com.app.emcurauc.b_health.assessment.new_assesment.ActivityOCD_Form;
import com.app.emcurauc.b_health.assessment.new_assesment.ActivityStressQues_Form;
...
import static com.app.emcurauc.GetLiveCare.bodyParts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgImmeAppt.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                DATA.print("-- checkedid = "+ checkedId + " R.id.rbImmediateCate : "+R.id.rbImmediateCare + " R.id.rbApptmnt : "+R.id.rbApptmnt);
        ...
        spSymptomNew.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                DATA.print("-- spinner selection: selectedSympId = "+selectedSympId);
            }
