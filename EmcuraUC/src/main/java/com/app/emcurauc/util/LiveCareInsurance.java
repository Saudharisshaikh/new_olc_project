...
import com.app.emcurauc.ActivityCovidTest;
import com.app.emcurauc.ActivityInsurance;
import com.app.emcurauc.AddFamilyMember;
import com.app.emcurauc.BookAppointment;
import com.app.emcurauc.NewSignup;
import com.app.emcurauc.R;
import com.app.emcurauc.Signup;
import com.app.emcurauc.adapter.ACTV_InsuranceAdapter;
import com.app.emcurauc.adapter.DialogInsuranceAdapter;
...
public class LiveCareInsurance implements ApiCallBack, LiveCareInsuranceInterface {
    ...
    public void showInsurancesList(){
        ...
        if(myInsuranceBeen.isEmpty()){
            ...
            Log.d("--firstD", "showInsurancesList: ");
...
//        dialogCrediCard.getWindow().setAttributes(a);
    ...
    private boolean isForFamilyMember;
    public static String familyFistName, familyLastName, familyDob;

    public void getSimpleState(boolean isForFamilyMember) {

        this.isForFamilyMember = isForFamilyMember;
    ...
    private String insurance = "", payerName = "";
    ...
    private void showAddInsuranceDialog(){
        ...
        if(isForFamilyMember){
            etFname.setText(LiveCareInsurance.familyFistName);
            etLname.setText(LiveCareInsurance.familyLastName);
            etDOB.setText(LiveCareInsurance.familyDob);
        }else {
        ...
        ivIDfrontImg = dialog.findViewById(R.id.ivIDfrontImg);
        ivDeleteIDfrontImg = dialog.findViewById(R.id.ivDeleteIDfrontImg);
        ivIDbackImg = dialog.findViewById(R.id.ivIDbackImg);
        ivDeleteIDbackImg = dialog.findViewById(R.id.ivDeleteIDbackImg);
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.ivICfrontImg:
                        ...
                        }else if(activity instanceof ActivityCovidTest){
                            ((ActivityCovidTest) activity).callPicCardImgMethod(1, LiveCareInsurance.this);
                        }else if(activity instanceof AddFamilyMember){
                            ((AddFamilyMember) activity).callPicCardImgMethod(1, LiveCareInsurance.this);
                        }
                        break;
                    ...
                    case R.id.ivICbackImg:
                        if(activity instanceof ActivityInsurance){
                            ...
                            ((ActivityCovidTest) activity).callPicCardImgMethod(2, LiveCareInsurance.this);
                        }else if(activity instanceof AddFamilyMember){
                            ((AddFamilyMember) activity).callPicCardImgMethod(2, LiveCareInsurance.this);
                        }
                        break;
                    ...
                    case R.id.ivIDfrontImg:
                        if(activity instanceof ActivityInsurance){
                            ((ActivityInsurance) activity).callPicCardImgMethod(3, LiveCareInsurance.this);
                        }else if(activity instanceof PaymentLiveCare){
                            ((PaymentLiveCare) activity).callPicCardImgMethod(3, LiveCareInsurance.this);
                        }else if(activity instanceof BookAppointment){
                            ((BookAppointment) activity).callPicCardImgMethod(3, LiveCareInsurance.this);
                        }else if(activity instanceof ActivityCovidTest){
                            ((ActivityCovidTest) activity).callPicCardImgMethod(3, LiveCareInsurance.this);
                        }else if(activity instanceof AddFamilyMember){
                            ((AddFamilyMember) activity).callPicCardImgMethod(3, LiveCareInsurance.this);
                        }
                        break;
                    ...
                    case R.id.ivIDbackImg:
                        if(activity instanceof ActivityInsurance){
                            ((ActivityInsurance) activity).callPicCardImgMethod(4, LiveCareInsurance.this);
                        }else if(activity instanceof PaymentLiveCare){
                            ((PaymentLiveCare) activity).callPicCardImgMethod(4, LiveCareInsurance.this);
                        }else if(activity instanceof BookAppointment){
                            ((BookAppointment) activity).callPicCardImgMethod(4, LiveCareInsurance.this);
                        }else if(activity instanceof ActivityCovidTest){
                            ((ActivityCovidTest) activity).callPicCardImgMethod(4, LiveCareInsurance.this);
                        }else if(activity instanceof AddFamilyMember){
                            ((AddFamilyMember) activity).callPicCardImgMethod(4, LiveCareInsurance.this);
                        }
                        break;
        ...
        btnVarifyInsurance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(TextUtils.isEmpty(iCardFrontImgPath)){
                    customToast.showToast("Please add your insurance card front image", 0, 1);
                }else if(TextUtils.isEmpty(iCardBackImgPath)){
                    customToast.showToast("Please add your insurance card back image", 0, 1);
                }else if(TextUtils.isEmpty(idCardFrontImgPath)){
                    customToast.showToast("Please add your ID card front image", 0, 1);
                }else if(TextUtils.isEmpty(idCardBackImgPath)){
                    customToast.showToast("Please add your ID card back image", 0, 1);
                }else {

                    if(isForFamilyMember){

                        AddFamilyMember.myInsuranceBeanNewIns = new MyInsuranceBean("", "", insurance, policyNo,group,code, payerName, "",
                                iCardFrontImgPath, iCardBackImgPath, idCardFrontImgPath, idCardBackImgPath);

                        dialog.dismiss();

                        if(activity instanceof AddFamilyMember){
                            ((AddFamilyMember) activity).displayInsurance();
                        }else if(activity instanceof ActivityCovidTest){
                            saveInsuranceInfo(insurance,policyNo,group,code, GloabalMethods.subUsersModel.id);
                        }
                    }else {
                        saveInsuranceInfo(insurance,policyNo,group,code, prefs.getString("id", "0"));
                    }
                }
            }
        });
    ...
    private void showInsuranceSelectionDialog(final EditText etInsuranceInput){
        ...
        lvInsurance.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                payerName = selectedPayerBean.payer_name;
    ...
    private void saveInsuranceInfo(String insurance, String p_no, String group, String code, String patientID) {
        RequestParams params = new RequestParams();
        ...
        if(! TextUtils.isEmpty(idCardFrontImgPath)){
            try {params.put("id_front", new File(idCardFrontImgPath));} catch (FileNotFoundException e) {e.printStackTrace();}
        }
        if(! TextUtils.isEmpty(idCardBackImgPath)){
            try {params.put("id_back", new File(idCardBackImgPath));} catch (FileNotFoundException e) {e.printStackTrace();}
        }
    ...
    public void fetchDataCallback(String httpStatus, String apiName, String content) {
        if(apiName.equals(ApiManager.GET_MY_INSURANCE)){
            try {
                ...
                if(showLoader){
                    Log.d("--secondD", "fetchDataCallback: ");
                   // showInsuranceListDialog();
                }
                    ...
                    alertDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public void onDismiss(DialogInterface dialogInterface) {
                            ...
                            if(activity instanceof ActivityInsurance){
                                ...
                                ((ActivityCovidTest) activity).getMyInsurance();
                            }else {
