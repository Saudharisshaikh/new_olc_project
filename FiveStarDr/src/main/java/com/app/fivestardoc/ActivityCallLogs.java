...
import com.app.fivestardoc.adapter.CallLogsAdapter;
...
import com.app.fivestardoc.util.DialogCallDetails;
...
public class ActivityCallLogs extends BaseActivity implements GloabalSocket.SocketEmitterCallBack{
	...
	private boolean isFromPatientScreen;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isFromPatientScreen = getIntent().getBooleanExtra("isFromPatientScreen", false);
	...
	private void getCallLogs(int pageNo) {
		...
		callHistAPI = isFromPatientScreen ? "calling/call_history_patient"+"/"+pageNo+"/"+prefs.getString("id", "")+"/"+DATA.selectedUserCallId :
				ApiManager.CALL_HISTORY+"/"+pageNo+"/"+prefs.getString("id", "");

		ApiManager apiManager = new ApiManager(callHistAPI,"get",params,apiCallBack, activity);
		apiManager.loadURL();
	}//end getCallLogs
	...
	public void fetchDataCallback(String status, String apiName, String content) {
		...
		if(apiName.contains(callHistAPI)){
