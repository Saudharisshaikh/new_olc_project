...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	//public static final String CURRENT_APP = "doctor";//by zohaib for urgent care doc
	public static final String CURRENT_APP = "doctor_fivestar";//by zohaib for OLC US doc
	public static final String HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";
	public static String HOSPITAL_ID_EMCURA = "16"; //16 fivestar hosp id
...
*/
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnAppUpdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.app.fivestardoc&hl=en"));
				startActivity(intent);
			}
		});
	...
	String device_token,nameofStates;
			...
			try {
				...
				if(status.equals("success")) {
					...
					for (int i = 0; i < statesArray.length(); i++) {
						...
						stateJson.getString("id");
						stateJson.getString("doctor_id");
						stateJson.getString("state_id");
						nameofStates =  stateJson.getString("full_name");
						stateNames.add(nameofStates);
					}
					...
					String commaSeparatedNames = TextUtils.join(",", stateNames);
					ed.putString("stateOfPractice", commaSeparatedNames);
...
//					getOAuthToken(); //Momi's Changes 6/7/23
					openActivity.open(MainActivityNew.class, true);//Splash
				...
				customToast.showToast(e1.getMessage(),0,0);
				e1.printStackTrace();
			}
		}
