...
import com.app.fivestardoc.adapter.CategoriesAdapter;
import com.app.fivestardoc.api.ApiCallBack;
import com.app.fivestardoc.api.ApiManager;
import com.app.fivestardoc.model.CategoriesModel;
import com.app.fivestardoc.permission.PermissionsActivity;
import com.app.fivestardoc.permission.PermissionsChecker;
import com.app.fivestardoc.services.GPSTracker;
import com.app.fivestardoc.util.ActionEditText;
import com.app.fivestardoc.util.CallWebService;
...
public class MainActivityNew extends AppCompatActivity implements ApiCallBack, GloabalSocket.SocketEmitterCallBack{
	...
	CardView tvLiveCare,tvWaitingLiveCare;
		...
		tvLiveCare.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(checkInternetConnection.isConnectedToInternet()) {
					...
					Intent intent = new Intent(activity,LiveCare.class);
					intent.putExtra("isForLiveCare", true);
...
//		DATA.allCategories.add(new CategoriesModel("3", "Lab Requests",R.drawable.ic_drawer_lab_requests));
		DATA.allCategories.add(new CategoriesModel("12", "My Messages",R.drawable.ic_drawer_my_messages));
		DATA.allCategories.add(new CategoriesModel("13", "Call History",R.drawable.ic_drawer_call_history));
...
//					break;
//				case 4:
//					openActivity.open(ActivityLabRequests.class, false);
//					break;
				case 3:
					openActivity.open(ConversationsActivity.class, false);
					break;
...
//				setTitle(patientArry[position]);
	...
	public void showSupportDialog(){
		...
		if(TextUtils.isEmpty(support_email)){
			support_email = "support@onlinecare.com";
		}
		...
		btnTextSupport.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String[] addresses = {"support@onlinecare.com"};

				Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
						"mailto","support@onlinecare.com", null));
