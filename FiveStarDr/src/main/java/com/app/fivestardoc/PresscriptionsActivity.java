...
public class PresscriptionsActivity extends BaseActivity implements ApiCallBack{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lvCancelpress = findViewById(R.id.lvCancelpress);
		...
		if(apiName.equalsIgnoreCase(ApiManager.GET_PRESCRIPTIONS)){
			...
			try {
				...
				for (int i = 0; i < data.length(); i++) {
					...
					String presStatus = object.optString("status");
					String reqType = object.optString("request_type");
					String  patient_id= object.optString("patient_id");
					String  doctor_id= object.optString("patient_id");
					...
					String  dateof= object.optString("dateof");
					String  first_name= object.optString("first_name");
					String  last_name= object.optString("last_name");
					String  image= object.optString("image");
					String  signature= object.optString("signature");
					String ppStatus = object.optString("ppstatus");

					prescriptionBean = new PrescriptionBean(id, presStatus, reqType, patient_id, doctor_id, vitals, diagnosis, treatment, dateof, first_name, last_name, image,signature, ppStatus);

					prescriptionBean.quantity = object.optString("quantity");
					prescriptionBean.directions = object.optString("directions");
					prescriptionBean.drug_name = object.optString("drug_name");
...
//					String signature = object.optString("signature");
//					String dateof = object.optString("dateof");
//					String prescribed_by = object.optString("prescribed_by");
