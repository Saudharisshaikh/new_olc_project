...
import com.app.fivestardoc.model.ConditionsModel;
import com.app.fivestardoc.model.ConversationBean;
import com.app.fivestardoc.model.CountryBean;
import com.app.fivestardoc.model.DoctorsModel;
import com.app.fivestardoc.model.DrAppointmentModel;
import com.app.fivestardoc.model.DrugBean;
import com.app.fivestardoc.model.MyAppointmentsModel;
import com.app.fivestardoc.model.PastHistoryBean;
import com.app.fivestardoc.model.RefillBean;
import com.app.fivestardoc.model.RelativeHadBean;
import com.app.fivestardoc.model.ReportsModel;
import com.app.fivestardoc.model.SpecialityModel;
import com.app.fivestardoc.model.StateBean;
import com.app.fivestardoc.model.SubUsersModel;
import com.app.fivestardoc.model.SymptomsModel;
...
public class DATA {
	...
	//public static final String ROOT_Url = "https://www.olcmentalhealth.com/";
	public static final String SIGNUP_URL = ROOT_Url + "onlinecare_accounts/index.php/app/";

//	public static final String ROOT_Url = "https://telelivecare.com/";
//	public static final String SIGNUP_URL = ROOT_Url + "onlinecareus/index.php/app/";
	...
	public static final String APP_THEME_RED_COLOR = "#1c3496";
	...
	public static ArrayList<MyAppointmentsModel> allAppointments,allAppointmentsCompleted;
...
//	public static VideoChatConfig videoChatConfig;
	...
	public static String selectedUserCallDOB = "";
	...
	public static void loadImageFromURL(String imageURL,int placeholder, final ImageView iv) {
		try {
			Glide.with(OnlineCareDr.getInstance().getApplicationContext()).setDefaultRequestOptions(new RequestOptions().placeholder(placeholder).error(placeholder)).load(imageURL).into(iv);
	...
	public static final String NOTIF_TYPE_COVID_REQ = "covid_request";
	public static final String NOTIF_TYPE_CARE_REQ = "care_request";
		 ...
		 /*public void callService() {
			...
			client.post(DATA.baseUrl+"/logout", params, new AsyncHttpResponseHandler() {
				...
				public void onFailure(Throwable error, String content) {
					DATA.dismissLoaderDefault();
					DATA.print("--onfail logout" +content);
		 ...
		 public static void showLoader(final Context context) {
		    	...
		    	countDownTimer = new CountDownTimer(800 * 7, 800) {
		    		public void onTick(long millisUntilFinished) {
		    			...
		    			DATA.print("--value of i before switch "+i);
		    			switch (i){
		    			case 0:
...
//		    			.changeAlertType(SweetAlertDialog.SUCCESS_TYPE);
	...
	public static AppBean2 appBean_GM;
