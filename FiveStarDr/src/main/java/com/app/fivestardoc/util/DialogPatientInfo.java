...
public class DialogPatientInfo implements ApiCallBack {
    ...
    public void showDialog(){
        ...
        tvICcodes = (TextView)infoDialog.findViewById(R.id.tvIcdCodes);
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        ...
        if(apiName.contains(ApiManager.PATIENT_DETAIL)){
            try {
                ...
                DATA.print("patId="+patient_ID_ICD+" = "+patientIdGCM);
                //Log.d("--bothIds", "fetchDataCallback: "+patient_ID_ICD+"  - "+patientIdGCM);
                if(patient_ID_ICD.equalsIgnoreCase(patientIdGCM)){
                    tvICcodes.setText(patient_icd_codes);
                }else {
                    tvICcodes.setText("-");
                }
