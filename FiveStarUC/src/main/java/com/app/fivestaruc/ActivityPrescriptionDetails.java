...
import com.app.fivestaruc.adapter.PrescriptionDetailAdapter;
...
import com.app.fivestaruc.util.GeneralAlertDialog;
...
public class ActivityPrescriptionDetails extends BaseActivity implements PrescriptionDetailListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prescriptionDetailAdapter = new PrescriptionDetailAdapter(this,
				prescriptionDetailModelArrayList,this);
...
//        dialogAiSuggestedPresp.getWindow().setAttributes(lp);
	...
	public void getPrescriptionDetails() {
		...
		ApiManager apiManager = new ApiManager(ApiManager.PATIENT_PRESCRIPTION_DETAILS,
