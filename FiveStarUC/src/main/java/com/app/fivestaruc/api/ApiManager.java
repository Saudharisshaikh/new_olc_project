package com.app.fivestaruc.api;
...
import static com.app.fivestaruc.util.DATA.SIGNUP_URL;
import static com.app.fivestaruc.util.DATA.baseUrl;
...
public class ApiManager {
	...
	public static final String PATIENT__SOCIAL_LOGIN = "patient/social_login";
	...
	public static final String GET_ALL_LAB_REQUEST = "lab_requests/getAll";
	public static final String VIEW_LAB_REQUEST = "lab_requests/getLab";
	public static final String UPLOAD_LAB_REQUEST_RESULT = "lab_requests/uploadResult";
	...
	public static final String SEARCH_DOCTOR_BY_STATE = "doctor/searchDoctor/mi";
	...
	public static final String GET_PRESCRIPTIONS = "patient/getPrescriptions";
	public static final String SAVE_PATIENT_REFILL_REQUEST = "savePatientsRefillRequest";
	public static final String GET_PATIENT_PRESC_DETAILS = "patient/getPatientsPrescriptionDetails";
	...
	public static final String REMOVE_FROM_UC = "doctor/removePatientFromUrgent";
	public static final String CANCEL_UC_REASON = "patient/cancel_urgentcare";
	public static final String UPDATE_UC_SYMP = "livecare/update";
	public static final String GET_UC_DETAILS = "livecare/getdetail";
	...
	public static final String HOSPITAL_DATA = "general/hospital_data";
	...
	public static final String GET_COVID_SYMPTOMS = "ctesting/symptoms";
	public static final String SAVE_COVID_TEST_FORM = "ctesting/saveform";//"ctesting/symptoms_iphone" in iphone
	public static final String COVID_FORMS_LIST_PATIENT = "ctesting/get_patient_listing";
    public static final String SAVE_COVID_TEST_FORM2 = "ctesting/cares_act";
	public static final String COVID_TEST_LOCATIONS = "ctesting/testlocations";

	public static final String PROFILE_QR = "patient/barcode";
	...
	public static final String GET_INSURANCE = "surescript/getInsurance";
	...
	public static final String COVID_FORM2 = "cvd_form2.json";

	// Saud work starts here...

	public static final String CHECK_APP_UPDATES = "general/checkversion";

	public static final String MY_PATIENT_PRESCRIPTION = "prescription/viewlist_patient";
	public static final String PATIENT_PRESCRIPTION_DETAILS = "prescription/getPrescriptionDetail";
