...
package com.app.fivestaruc.fcm;
...
import com.app.fivestaruc.ActivityEliveAssignedPopup;
import com.app.fivestaruc.ActivityLabRequests;
import com.app.fivestaruc.BuildConfig;
import com.app.fivestaruc.ConversationsActivity;
import com.app.fivestaruc.GetLiveCare;
import com.app.fivestaruc.LiveCareWaitingArea;
import com.app.fivestaruc.Login;
import com.app.fivestaruc.MainActivityNew;
import com.app.fivestaruc.MyAppointments;
import com.app.fivestaruc.OnlineCare;
import com.app.fivestaruc.R;
import com.app.fivestaruc.ShowGroupMessagePopup;
import com.app.fivestaruc.ShowMessagePopupActivity;
import com.app.fivestaruc.SupportMessagesActivity;
import com.app.fivestaruc.VCallModule;
import com.app.fivestaruc.ViewConversationActivity;
...
import com.app.fivestaruc.util.IncomingCallResponse;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static boolean callRejectStatus = false;
    ...
    private void generateAction(String response, final Context context) {
        ...
        try {
            ...
            if (jsonObject.has("response_type") && jsonObject.getString("response_type").equalsIgnoreCase("doctor_prescription")) {
                ...
                int presBadge = SharedPrefsHelper.getInstance().get("pres_badge_count", 0);
                presBadge = presBadge + 1;
                SharedPrefsHelper.getInstance().save("pres_badge_count",presBadge);
                sendNotification(jsonObject.getJSONObject("data").getString("message") , MainActivityNew.class);
                return;
            }

            if (jsonObject.has("response_type") && jsonObject.getString("response_type").equalsIgnoreCase("discharge_summary")) {
                sendNotification(jsonObject.getJSONObject("data").getString("message") , MainActivityNew.class);
                return;
            }
            ...
            else if (jsonObject.has("status") && jsonObject.getString("status").equalsIgnoreCase("new_lab_request"))
            {
...
//                }
                ...
                SharedPrefsHelper.getInstance().save("states" , states_logs);
                ...
                if(incoming_call_status == 1) {
                    ...
                    DATA.print("--callTime time "+callTime);
                    DATA.print("--new Date "+new Date());
    ...
    public void callNotification(){
        ...
        //Ahmer comment this code for temporary 16-05-2022
//        /*============================ Ahmer work =================================*/
//        //Intent for call Accept
//        Intent callAcceptIntent = new Intent(this, MainActivity.class);
//        callAcceptIntent.putExtra("fromNotificationcallAccept", true);
